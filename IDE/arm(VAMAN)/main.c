...
int main(void)
{
    ...
    //LED pins Output
    PyHal_GPIO_SetDir(18,1);// D0
    PyHal_GPIO_SetDir(21,1);// D1
    PyHal_GPIO_SetDir(22,1);// D2
    PyHal_GPIO_SetDir(5,1);// CLK

    PyHal_GPIO_SetDir(2,0);// Q0
    PyHal_GPIO_SetDir(3,0);// Q1
    PyHal_GPIO_SetDir(4,0);// Q2

    uint32_t Q0=0,Q1=0,Q2=0,D0,D1,D2;

     while(1)
     {
        PyHal_GPIO_Set(5,1);// CLK 
...
//	PyHal_GPIO_Set(22,0);
	...
	PyHal_GPIO_Set(18,D0);
	PyHal_GPIO_Set(21,D1);
	PyHal_GPIO_Set(22,D2);
